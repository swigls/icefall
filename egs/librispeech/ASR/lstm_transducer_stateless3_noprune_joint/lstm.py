...
class Conv2dSubsampling(nn.Module):
    ...
    def chunk_next_feature(
        ...
        Args:
          ...
          offset:
            Offset defines how much to shift in time
        Returns:
          Return a tensor of shape (N, T_h, D*subsampling).
        """
        assert x.ndim in (3,)
        assert x.size(-1) == 80
        N, T, D = x.shape
